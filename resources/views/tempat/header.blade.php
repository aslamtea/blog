...
<link rel="stylesheet" type="text/css" href="{{asset('frontend')}}/plugins/jquery.mb.YTPlayer-3.1.12/jquery.mb.YTPlayer.css">
...
<script src="{{asset('frontend')}}/plugins/jquery.mb.YTPlayer-3.1.12/jquery.mb.YTPlayer.js"></script>
<script src="{{asset('frontend')}}/plugins/easing/easing.js"></script>
<script src="{{asset('frontend')}}/plugins/masonry/masonry.js"></script>
<script src="{{asset('frontend')}}/plugins/masonry/images_loaded.js"></script>
